...
End Function
Function fLastWrittenCol(ws As Worksheet, Row As Long) As Long
    fLastWrittenCol = ws.Cells(Row, Columns.Count).End(xlToLeft).Column
End Function
...
'strDataFolder = ThisWorkbook.Path
'Set oFolder = oFSO.GetFolder(strDataFolder)
'
